...
#Added padding to x and y axis
#Edited data labels positioning
#Edited legend and titles
p2<-ggplot(data = transform(ticket_plane_price_long_restr,
                        Route = factor(Route, levels=c("Zurich-Milan",
                                                       "London-Amsterdam",
                                                       "Berlin-Warsaw",
                                                       ...
                                                       "London-Marseille"))))+
    labs(title = "Planes not always cheaper than trains",
       subtitle="The Change in Ticket prices Compared to Ticket Purchase 1 Week Prior for planes and trains on different routes",
